      ...
      case false:
        ...
        this.timer = setInterval(() => {
          if (this.state.running) {
            ...
            if (this.state.sessionRemainingSeconds <= 21 && this.state.timerLabel === "Travail") {
            ...
            } else if (this.state.breakRemainingSeconds > 0 && this.state.timerLabel === "Travail") { //wont continue
              this.setState({
                timerLabel: 'Pause'
              });
              window.alert("c'est le temps de pause");
  ...
  render() {
    return (
      <div id="clock">
        <h1>LePomodoro</h1>
        <div id="mainTimer">
          <h1 id='timer'>{(this.state.timerLabel==="Break") ?  this.formatMinutes(this.state.breakRemainingSeconds) : this.formatMinutes(this.state.sessionRemainingSeconds)}</h1>
        ...
        <div className="flexContainer">
          <div id='timerContainer'  className="flexContainer">
            <h3 id="session-label" className="timerContainerLabels">Travail</h3>
          ...
          <div id='timerContainer'  className="flexContainer">
            <h3 id="break-label"  className="timerContainerLabels">Pause</h3>
